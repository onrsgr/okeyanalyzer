...
public class BoardController {
    ...
    // Seri gidilmesi durumunda bütün ihtimallerin oluşturulup en optimize halinin dönüştürülemesini sağlar
    ...
    // Okey kullanılmışsa okeye ihtiyacı olan perleri işleme almaz
    ...
    // Eldeki olabilecek bütün perleri seri ve renkli olarak alır
    // Okey veya sahte okey varsa bu ihtimalleri de ekler
    private List<List<Integer>> findAllPossibleCombinations(List<List<Integer>> serialNumberCache, List<List<Integer>> serialColorCache, Player player, int okey) {
        ...
        //Aynı renk seri perlerin oluşturulduğu kısım.
        ...
        //Farklı renk aynı sayı perlerin oluşturulduğu kısım.
        for (List<Integer> serialNumberControl : serialColorCache) {
            flagForColoredNumbers = addNewColoredNumbers(getAllNumberCountsDifferentColors(serialNumberControl), flagForColoredNumbers);
        }
    ...
    // **** HAZIRLIK METHODLARI ****
    // Aynı renkteki perlere göre hazırlık yapar
    ...
    // Her renk için sayıların belirlenmesini sağlar ve hazırlık yapar
    ...
    //**** AYNI RENK PERLER ****
    // Aynı renkte per oluşturabilecek serileri bulur.
    // Okey veya Sahte Okey varsa burada değerlendirilir.
    ...
    // Okey ve sahte okeylerin eklenmesini sağlar
    ...
    //**** FARKLI RENK PERLER ****
    // Aynı renkteki sırları perlerin oluşturulmasını sağlar.
    ...
    // Farklı renklerdeki aynı sayıların bulunmasını sağlar
    private List<Integer> getAllNumberCountsDifferentColors(List<Integer> numbers) {
    ...
    // Renkli seri perlerin oluşturulmasını sağlar
    ...
    // **** ÇİFTE GİTME İŞLEMLERİ
    // Çift gidilirse yapılacak işlemler
